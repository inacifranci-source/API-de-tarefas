...
import type { criarCampos } from "../services/tarefaServices.js";
...
export async function buscarTarefaController(req: Request<{ id: string }>, res: Response) {
  try {
    const { id } = req.params;
...
export async function atualizarTarefaController(req: Request<{ id: string }>, res: Response) {
  try {
    const { id } = req.params;
...
export async function deletarTarefaController(req: Request<{ id: string }>, res: Response) {
  try {
    const { id } = req.params;
